...
VALUES ((SELECT $node_id FROM SickPerson WHERE id = 1),
 (SELECT $node_id FROM SickPerson WHERE id = 2)),
 ((SELECT $node_id FROM SickPerson WHERE id = 1),
 (SELECT $node_id FROM SickPerson WHERE id = 5)),
 ((SELECT $node_id FROM SickPerson WHERE id = 2),
 (SELECT $node_id FROM SickPerson WHERE id = 3)),
 ((SELECT $node_id FROM SickPerson WHERE id = 3),
 (SELECT $node_id FROM SickPerson WHERE id = 1)),
 ((SELECT $node_id FROM SickPerson WHERE id = 3),
 (SELECT $node_id FROM SickPerson WHERE id = 6)),
 ((SELECT $node_id FROM SickPerson WHERE id = 4),
 (SELECT $node_id FROM SickPerson WHERE id = 2)),
 ((SELECT $node_id FROM SickPerson WHERE id = 5),
 (SELECT $node_id FROM SickPerson WHERE id = 4)),
 ((SELECT $node_id FROM SickPerson WHERE id = 6),
 (SELECT $node_id FROM SickPerson WHERE id = 7)),
 ((SELECT $node_id FROM SickPerson WHERE id = 6),
 (SELECT $node_id FROM SickPerson WHERE id = 8)),
 ((SELECT $node_id FROM SickPerson WHERE id = 8),
 (SELECT $node_id FROM SickPerson WHERE id = 3)),
 ((SELECT $node_id FROM SickPerson WHERE id = 6), 
 (SELECT $node_id FROM SickPerson WHERE id = 10)),
 ((SELECT $node_id FROM SickPerson WHERE id = 7),
 (SELECT $node_id FROM SickPerson WHERE id = 6)),
 ((SELECT $node_id FROM SickPerson WHERE id = 5),
 (SELECT $node_id FROM SickPerson WHERE id = 1)),
 ((SELECT $node_id FROM SickPerson WHERE id = 7),
  (SELECT $node_id FROM SickPerson WHERE id = 10)),
  ((SELECT $node_id FROM SickPerson WHERE id = 10),
  (SELECT $node_id FROM SickPerson WHERE id = 9)),
  ((SELECT $node_id FROM SickPerson WHERE id = 9),
  (SELECT $node_id FROM SickPerson WHERE id = 8));
...
VALUES ((SELECT $node_id FROM Hospital WHERE ID = 1),
 (SELECT $node_id FROM City WHERE ID = 1)),
 ((SELECT $node_id FROM Hospital WHERE ID = 2),
 (SELECT $node_id FROM City WHERE ID = 2)),
 ((SELECT $node_id FROM Hospital WHERE ID = 3),
 (SELECT $node_id FROM City WHERE ID = 3)),
 ((SELECT $node_id FROM Hospital WHERE ID = 4),
 (SELECT $node_id FROM City WHERE ID = 4)),
  ((SELECT $node_id FROM Hospital WHERE ID = 5),
 (SELECT $node_id FROM City WHERE ID = 5)),
 ((SELECT $node_id FROM Hospital WHERE ID = 6),
 (SELECT $node_id FROM City WHERE ID = 6)),
 ((SELECT $node_id FROM Hospital WHERE ID = 7),
 (SELECT $node_id FROM City WHERE ID = 1)),
 ((SELECT $node_id FROM Hospital WHERE ID = 8),
 (SELECT $node_id FROM City WHERE ID = 7)),
 ((SELECT $node_id FROM Hospital WHERE ID = 9),
 (SELECT $node_id FROM City WHERE ID = 2)),
 ((SELECT $node_id FROM Hospital WHERE ID = 10),
 (SELECT $node_id FROM City WHERE ID = 10));


INSERT INTO BeTreated ($from_id, $to_id, betreated)
VALUES ((SELECT $node_id FROM SickPerson WHERE ID = 1),
 (SELECT $node_id FROM Hospital WHERE ID = 1), 10),
 ((SELECT $node_id FROM SickPerson WHERE ID = 8),
 (SELECT $node_id FROM Hospital WHERE ID = 1), 9),
 ((SELECT $node_id FROM SickPerson WHERE ID = 2),
 (SELECT $node_id FROM Hospital WHERE ID = 2), 8),
 ((SELECT $node_id FROM SickPerson WHERE ID = 3),
 (SELECT $node_id FROM Hospital WHERE ID = 3), 9),
 ((SELECT $node_id FROM SickPerson WHERE ID = 4),
 (SELECT $node_id FROM Hospital WHERE ID = 3), 7),
 ((SELECT $node_id FROM SickPerson WHERE ID = 5),
 (SELECT $node_id FROM Hospital WHERE ID = 6), 9),
 ((SELECT $node_id FROM SickPerson WHERE ID = 6),
 (SELECT $node_id FROM Hospital WHERE ID = 4), 10),
 ((SELECT $node_id FROM SickPerson WHERE ID = 8),
 (SELECT $node_id FROM Hospital WHERE ID = 4), 9),
 ((SELECT $node_id FROM SickPerson WHERE ID = 1),
 (SELECT $node_id FROM Hospital WHERE ID = 7), 7),
 ((SELECT $node_id FROM SickPerson WHERE ID = 8),
 (SELECT $node_id FROM Hospital WHERE ID = 9), 2),
 ((SELECT $node_id FROM SickPerson WHERE ID = 2),
 (SELECT $node_id FROM Hospital WHERE ID = 5), 8),
 ((SELECT $node_id FROM SickPerson WHERE ID = 9),
 (SELECT $node_id FROM Hospital WHERE ID = 6), 3),
 ((SELECT $node_id FROM SickPerson WHERE ID = 7),
 (SELECT $node_id FROM Hospital WHERE ID = 8), 7),
 ((SELECT $node_id FROM SickPerson WHERE ID = 10),
 (SELECT $node_id FROM Hospital WHERE ID = 10), 9);
